...
$result = mysqli_query($conn, "SELECT*FROM streaming WHERE genre LIKE '%Comedy%' ");
$result2 = mysqli_query($conn, "SELECT*FROM streaming WHERE genre LIKE '%Romance%' ");
?>
...
<h4 class="latest-text" id="comedy" style="margin-left:110px;">Comedy </h4>
<div class="container">
    <?php
...
<h4 class="latest-text" id="romance" style="margin-left:110px;">Romance </h4>
<div class="container">
...
<li><a class="last" href="Category2.php">Next</a></li>
</ul>
