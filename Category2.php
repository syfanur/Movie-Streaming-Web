...
$result = mysqli_query($conn, "SELECT*FROM streaming WHERE genre LIKE '%Mystery%' ");
$result2 = mysqli_query($conn, "SELECT*FROM streaming WHERE genre LIKE '%Horror%' ");
?>
...
<h4 class="latest-text" id="mystery" style="margin-left:110px;">Mystery </h4>
<div class="container">
    <?php
...
<h4 class="latest-text" id="horror" style="margin-left:110px;">Horror </h4>
<div class="container">
...
<div class="col-md-2 w3l-movie-gride-agile">
    <a href="StreamingPage.php?id=<?=$data2['id']?>"><img src="<?= $data2["poster"] ?>" width="180px;" height="250px" />
    </a>
